...
Potential interactions are considered for each frame; the exact methodology will be discussed in the later sections.

Observation qualia definition
=============================
...
We combine these axiomatic categories to define the occurrences of observation qualia at a given time.
