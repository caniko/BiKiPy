...
df = pd.read_parquet("cheeseboard-cheeseboard.parquet")
...
reward_trace_records = pd.DataFrame.from_dict(average_day(reward_trace_raw), orient="index", columns=["RewardTrace"])
