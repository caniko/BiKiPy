...
class CheeseboardTrial(CircleEnclosedTrial):
    ...
    @property
    def reward_trace_time(self) -> float:
        ...
        reward_boolean = single_node_tolerance_filter(
        ...
        reward_arrival_idx = np.where(reward_boolean)[0]
    ...
    def _trial_feature_series_list(self) -> list[pd.Series]:
        ...
        upstream_list.append(pd.Series([self.reward_trace_time], index=[("Cheeseboard", "RewardTraceTime")]))
