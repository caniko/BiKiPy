...
class OlfactionHeuristic(AbstractSoloHeuristic, ProximityMixin, RayMixin):
    ...
    manual_nose_olfaction_rays: Optional[AbstractComputeRayOffsetFilter] = None
    ...
    @computed_field  # type: ignore[misc]
    @cached_property
    def snout_towards_object_rays(self) -> AbstractComputeRayOffsetFilter:
        return (
