...
from bikipy.ingress.utils.perimeter import load_settings, init_all_perimeters
...
def init_settings(
    ...
    experiment_schema["optional"]["data_import_kwargs"] = extended_schema(DeepLabCutReader.schema(), with_required=False)["optional"]
    return {
