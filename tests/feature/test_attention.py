...
def test_proximity_filter():
    coordinates_inside_perimeter = expand_parallelogram(perimeter_object.corners, -1.0)
    coordinates_outside_perimeter = expand_parallelogram(perimeter_object.corners, 1.0)
